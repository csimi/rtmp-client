...
class Client extends EventEmitter {
	...
	connect () {
		if (!this.socket) {
			this.socket = createConnection(this.port, this.hostname, this.onConnect.bind(this));
			this.socket.once('close', this.onClose.bind(this));
			this.socket.once('error', this.onClose.bind(this));
		}
	}
	...
	onConnect () {
		...
		this.handshake.once('done', this.onHandshake.bind(this));
	}
